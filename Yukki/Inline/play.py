...
def search_markup(
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="🗑 Bağlayın", callback_data=f"forceclose {query}|{user_id}"
            ),
            InlineKeyboardButton(
                text=">", callback_data=f"popat 1|{query}|{user_id}"
            ),
...
def secondary_markup(videoid, user_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="🔗 Daha çox Menyu", callback_data=f"other {videoid}|{user_id}"
            ),
            InlineKeyboardButton(text="🗑 Menyunu bağlayın", callback_data=f"close"),
        ],
    ]
    return buttons
...
audio_markup2 = InlineKeyboardMarkup(
    [
        ...
        [InlineKeyboardButton("🗑 Menyunu bağlayın", callback_data="close")],
    ]
)
